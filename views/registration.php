    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        if (empty($errors)) {
            ...
            if ($check_result->num_rows > 0) {
                ...
                if ($stmt->execute()) {
                    echo '<script>window.location.href = "index.php?action=registration_successful"</script>';
                    exit();
                } else {
                    ...
                    <div class="card-body">
                        <form method="post" class="p-4">
                            ...
                            <div class="form-group form-check mb-2">
                                ...
                                <label class="form-check-label" for="userAgreement">Я погоджуюсь з <a class="btn-link text-dark" target="_blank" href="index.php?action=terms_of_service">Умовами користування</a></label>
                            </div>
                            <div class="form-group form-check mb-4">
                                <input type="checkbox" class="form-check-input" id="privacyPolicy" required>
                                <label class="form-check-label" for="privacyPolicy">Я погоджуюсь з <a class="btn-link text-dark" target="_blank" href="index.php?action=privacy_policy">Політикою конфіденційності</a></label>
                            </div>
